...
custom_replacements = {
  ...
  */
  names = {
    ...
    defender_email_security_contact = "simon@neuralmotion.com.au"
    ...
    #remove ddos# ddos_resource_group_name                       = "rg-hub-ddos-$${starter_location_01}"
    asc_export_resource_group_name                 = "rg-asc-export-$${starter_location_01}"

    # Resource names management
    log_analytics_workspace_name            = "law-management-$${starter_location_01}"
    #remove ddos# ddos_protection_plan_name               = "ddos-$${starter_location_01}"
    ...
    #remove bastion# primary_bastion_host_name                                    = "bas-hub-$${starter_location_01}"
    #remove bastion# primary_bastion_host_public_ip_name                          = "pip-bastion-hub-$${starter_location_01}"
    ...
    #remove bastion# secondary_bastion_host_name                                    = "bas-hub-$${starter_location_02}"
    #remove bastion# secondary_bastion_host_public_ip_name                          = "pip-bastion-hub-$${starter_location_02}"
    ...
    #remove bastion# primary_bastion_subnet_address_prefix              = "10.0.0.64/26"
    ...
    #remove bastion# secondary_bastion_subnet_address_prefix              = "10.1.0.64/26"
  ...
  */
  resource_group_identifiers = {
    ...
    #remove ddos# ddos_protection_plan_resource_group_id = "/subscriptions/$${subscription_id_connectivity}/resourcegroups/$${ddos_resource_group_name}"
  }
  ...
  */
  resource_identifiers = {
    ...
    #remove ddos# ddos_protection_plan_id                     = "$${ddos_protection_plan_resource_group_id}/providers/Microsoft.Network/ddosProtectionPlans/$${ddos_protection_plan_name}"
  }
}
...
management_group_settings = {
  ...
  policy_default_values = {
    ...
    #remove ddos# ddos_protection_plan_id                     = "$${ddos_protection_plan_id}"
